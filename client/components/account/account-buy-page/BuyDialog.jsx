...
const BuyDialog = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            form.append("usd", String(amountOnDollars));
            form.append("cardNumber", "4242-4242-4242-4242"); // mock

            const res = await axios.post(`${process.env.NEXT_PUBLIC_API}/buy`, form);
            const data = res.data;
        ...
        <div>
            <div className='bg-[#1C1C1C] backdrop:blur-2xl p-6 rounded-lg max-w-2xl mx-auto min-h-[600px] max-h-max'>
                ...
                <form onSubmit={handleSubmit} className='space-y-8 mt-6'>
                    ...
                    <div className="w-full flex flex-col lg:flex-row items-center gap-y-6 gap-x-6">
                        <div className='flex flex-col gap-y-2 w-full lg:w-1/2 space-y-4'>
                            ...
                            <div className="flex items-center gap-x-2">
                                ...
                                <Input type="text" placeholder="0.00" className="outline-none ring-0! focus:ring-0! p-5 indent-0 rounded-b-none border-0 border-b-2 border-neutral-500 text-neutral-400"
